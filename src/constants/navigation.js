...
export const sidebarSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Medical Records", href: routes.emr, icon: FileText },
      { label: "Prescriptions", href: routes.prescriptions, icon: Pill },
      { label: "Vaccination & Deworming", href: routes.vaccinationDeworming, icon: Syringe },
      { label: "Follow-ups", href: routes.followUps, icon: CalendarClock },
